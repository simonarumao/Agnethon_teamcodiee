...
// AC7091b24420d86d29c9432b0199e64f2f
const accountSid = 'AC2c056d8ea739bc348425aec8d9338f2e';
// b9da271f35b30dbe77e4b868e791d809
const authToken = '38adc1dae86f079d34dba594b72499b6';
// +12059272504
const fromNumber = '+17245054634';
...
function checkAlertCondition(userLatitude, userLongitude, targetLatitude, targetLongitude, alertRadius) {
  ...
  // Convert latitude and longitu
  // 
  // de from degrees to radians
...
app.post('/send-alerts', async (req, res) => {
  const users = [
    ...
    { phone_number: '+919004445451', latitude: req.body.latitude, longitude: req.body.longitude },
      ...
      usersInTargetZone.map(async user => {
        ...
        while (retrycount < maxretries) {
          try {
            ...
            // Mock sending an alert via Voice Call (replace this with your actual Twilio Voice Call logic)
